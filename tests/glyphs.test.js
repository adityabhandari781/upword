...
test('Times New Roman starts at 24 pixels and reveals 8 more after a wrong guess', () => {
  ...
  assert.deepEqual(afterWrongGuessContext.clipRects, [[0, 52, dimensions.width, 32]]);
